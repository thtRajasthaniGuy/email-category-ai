...
export const EmailList = ({ filter = 'All' }: EmailListProps) => {
  const { emails, loading, error, summarizeEmail } = useEmailStore();
          ...
          <div className="h-full flex flex-col">
            ...
            <div className="p-6 border-b border-gray-200 bg-gray-50">
              <div className="flex justify-between items-start mb-4">
                <h1 className="text-xl font-semibold text-gray-900 flex-1 mr-4">
              ...
              <div className="space-y-4">
                {selectedEmail.isSummarizing ? (
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                      <div className="flex items-start">
                        ...
                        <div className="flex-1">
                          <div className="font-medium text-green-900 mb-2">Summary</div>
                    ...
                    {/* Action Items */}
                    {selectedEmail.actionItems && selectedEmail.actionItems.trim() && (
